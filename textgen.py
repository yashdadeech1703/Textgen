...
# tokenization
# standardization
# What is tokenization? Tokenization is the process of breaking a stress of text up into words phrases symbols or other
# meaningful elements
def tokenize_words(input):
    ...
    # filtering the stopwords using labels
...
# we'll sort the list of the set of all characters that appear in our i/p test and then use the enumerate fn
...
# just so we get an ideas of whether our process of converting words into characters has worked,
